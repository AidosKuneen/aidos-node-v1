...
public class Bundle {
    ...
    public Bundle(final byte[] bundle) {
        ...
        final Map<Long, Transaction> bundleTransactions = loadTransactionsFromMesh(bundlePointer);
    ...
    private Map<Long, Transaction> loadTransactionsFromMesh(final long bundlePointer) {
