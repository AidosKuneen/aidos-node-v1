...
public class APIIntegrationTests {
    ...
    public void shouldTestGetNodeInfo() {
        ...
        given().
            ...
            then().
                ...
                body(containsString("jreAvailableProcessors")).
                body(containsString("latestSolidSubmeshMilestone")).
                body(containsString("latestSolidSubmeshMilestoneIndex")).
     ...
     */
    @Test
    public void shouldTestGetPeerAddresses() {

        final Map<String, Object> request = new HashMap<>();
        request.put("command", "getPeerAddresses");
     ...
     * curl http://localhost:14265 \
     -X POST \
     -H 'Content-Type: application/json' \
     -d '{"command": "addPeer", "uri": ["tcp://8.8.8.8:14265"]}'
     */
    @Test
    public void shouldTestAddPeer() {

        final Map<String, Object> request = new HashMap<>();
        request.put("command", "addPeer");
        request.put("uris", new String [] {"tcp://8.8.8.8:14265"} );
        given().
                contentType("application/json").
                body(gson.toJson(request)).
                when().
                post("/").
                then().
                body(containsString("addedPeers")).
                body(containsString("duration")).
                statusCode(200);
    }
